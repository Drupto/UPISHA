    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          {state.type === 'valid' && (
            <div>
              <div className="bg-green-50 dark:bg-green-900/20 border-b border-green-200 dark:border-green-800 px-6 py-5 text-center">
                <BadgeCheck className="h-12 w-12 text-green-600 dark:text-green-400 mx-auto mb-2" />
              ...
              <div className="px-6 py-5 space-y-4">
                <div>
                  ...
                  <p className="text-lg font-semibold text-upisha-navy dark:text-white">
